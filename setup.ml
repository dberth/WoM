...
(* OASIS_START *)
(* DO NOT EDIT (digest: c27a9789150e9f73c03162dc0e591797) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./mahjong_engine.native", []))];
                    ...
                    (OASISExpr.EBool true,
                      Some
                        (("atdgen",
                           [
                              "-t";
                              "src/game_description/game_descr.atd";
                              "&&\\\natdgen";
                              "-b";
                              "src/game_description/game_descr.atd";
                              "&&\\\natdgen";
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "game_description";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "mahjong_engine";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/mahjong_engine";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "game_description";
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mahjong_engine";
                      lib_findlib_containers = []
                   });
               Object
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src/rules";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "mahjong_engine"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      obj_modules = ["Loader"; "Simple"; "Zung_jung"];
                      obj_findlib_fullname = Some ["rules"]
                   });
               Executable
                 ({
                     cs_name = "wom_nox";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "mahjong_engine";
                           InternalLibrary "rules"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "wom_nox.ml"});
               Executable
                 ({
                     cs_name = "wom_lambda";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "wom_lambda.ml"});
               Executable
                 ({
                     cs_name = "mahjong_engine_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "mahjong_engine.ml"});
               Executable
                 ({
                     cs_name = "mahjong_engine_perf_test_js";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "mahjong_engine_performance_js.ml"
                   });
               Executable
                 ({
                     cs_name = "mahjong_engine_perf_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "mahjong_engine_performance.ml"
                   });
               Executable
                 ({
                     cs_name = "engine_debugger";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "engine_debugger.ml"});
               Test
                 ({
                     cs_name = "mahjong_engine";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_working_directory = Some "_build/test";
                      test_run =
                        [
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\193\132\254\016w\249E\003\159\219V\028\141U\214=";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
