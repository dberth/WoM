...
let zj_reg_hand_test hand declared expected =
  ...
  assert_equal ~printer: string_of_float expected (Zung_jung.mahjong_pts (fun _ -> true) c1 (Tileset.tileset_of_tiles [c1]) mahjong declared)
...
let nine_gates _ctx =
    assert_equal ~printer: string_of_float 480. (Zung_jung.mahjong_pts (fun _ -> true) c1 (Tileset.tileset_of_tiles [c1; c1; c1; c1; c2; c3; c4; c5; c6; c7; c8; c9; c9; c9]) (Regular (List.map basic_tileset_of_tiles [[c1; c1; c1]; [c1; c2; c3]; [c4; c5; c6]; [c7; c8; c9]; [c9; c9]])) [])
